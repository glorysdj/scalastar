...
object Element {
  ...
  private final class LineElement(s: String) extends ArrayElement(Array(s)) {
    final override def width = s.length
    final override def height = 1
  }
